...
# I am developing a functions that gathers information about the hardware components of the system
#gathering information about the hardware components of the system
...
function Collect-ProcessorInfo {
   $Collected_Info = Get-WmiObject -Class Win32_Processor
    ...
    return $output.GetEnumerator() | Format-List    
...
# gathers information about the system Video controller.
...
#gathers information about the network components of the system.
...
$output = foreach ($info in $Collected_Info ) {
    [PSCustomObject]@{
        ...
        "DNS domain name" = $info.DNSDomain
        "DNS server" = $info.DNSServerSearchOrder
        "default gateway" = $info.DefaultIPGateway
...
# calling all the function and display output
Write-Output "  "
Write-Output "++++++++++++++++++                          Full System Information Report                          +++++++++++" 
